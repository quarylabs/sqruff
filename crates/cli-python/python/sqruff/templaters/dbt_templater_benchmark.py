...
def get_test_project_path() -> Path:
    ...
    potential_paths = [
        ...
        Path(os.environ.get("DBT_PROJECT_DIR", "")) if os.environ.get("DBT_PROJECT_DIR") else None,
    ]
    ...
    for i in range(iterations):
        ...
        for content, fname in files:
            ...
            templater = DbtTemplater(
                override_context=live_context,
                sqlfluff_config=config
            )
            try:
