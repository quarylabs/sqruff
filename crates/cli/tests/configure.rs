...
const SINGLE_RULE_CFG: &str = include_str!("configure/single_rule.cfg");
const SINGLE_RULE_SQL: &str = include_str!("configure/single_rule.sql");

/// Test a single rule in the config file with AL01 by
/// 1. Creating temporary folder
///
fn single_rule() {
