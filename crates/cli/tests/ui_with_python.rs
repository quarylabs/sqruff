...
fn main() {
    ...
    test_dir.push("tests/ui_with_python");
    ...
    for entry in fs::read_dir(&test_dir).unwrap() {
            ...
            .map_or(false, |ext| ext == "sql" || ext == "hql")
        {
            ...
            let stderr_normalized: String = stderr_str.replace(&test_dir_str, "tests/ui_with_python");
            let stdout_normalized: String = stdout_str.replace(&test_dir_str, "tests/ui_with_python");
