...
pub fn raw_dialect() -> Dialect {
    ...
    db2_dialect.sets_mut("unreserved_keywords").extend([
        "DETAILED",
        "EXTEND",
        "GENERATE",
        "HIGH",
    ...
    db2_dialect.add([
        (
            ...
            Sequence::new(vec![
                ...
                Ref::keyword("XMLPATTERN").to_matchable(),
                Ref::new("QuotedLiteralSegment").to_matchable(),
                Ref::new("XmlTypeClauseGrammar").to_matchable(),
            ])
            .to_matchable()
            .into(),
        ),
        (
            "XmlTypeClauseGrammar".into(),
            Sequence::new(vec![
                Ref::keyword("AS").to_matchable(),
        ...
        NodeMatcher::new(SyntaxKind::CreateIndexStatement, |_| {
            Sequence::new(vec![
                ...
                any_set_of(vec![
                    ...
                    .to_matchable(),
                    one_of(vec![
                        Ref::new("XmlIndexSpecificationGrammar").to_matchable(),
                    ...
                    .to_matchable(),
                    Sequence::new(vec![
                        Ref::keyword("LEVEL2").to_matchable(),
                        Ref::keyword("PCTFREE").to_matchable(),
                        Ref::new("NumericLiteralSegment").to_matchable(),
                    ])
                    .to_matchable(),
                    Sequence::new(vec![
                        Ref::keyword("MINPCTUSED").to_matchable(),
                        Ref::new("NumericLiteralSegment").to_matchable(),
                    ])
                    .to_matchable(),
                    Sequence::new(vec![
                        one_of(vec![
                            Ref::keyword("ALLOW").to_matchable(),
                            Ref::keyword("DISALLOW").to_matchable(),
                        ])
                        .to_matchable(),
                        Ref::keyword("REVERSE").to_matchable(),
                        Ref::keyword("SCANS").to_matchable(),
                    ])
                    .to_matchable(),
                    Sequence::new(vec![
                    ...
                    Sequence::new(vec![
                        ...
                        Sequence::new(vec![
                            one_of(vec![
                                Ref::keyword("SAMPLED").to_matchable(),
                                Ref::keyword("UNSAMPLED").to_matchable(),
                            ])
                            .config(|this| this.optional())
                            .to_matchable(),
                            Ref::keyword("DETAILED").to_matchable(),
                        ])
                        .config(|this| this.optional())
                        .to_matchable(),
