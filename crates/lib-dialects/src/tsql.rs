...
pub fn raw_dialect() -> Dialect {
    ...
    dialect.replace_grammar(
        ...
        one_of(vec![
            ...
            Ref::new("AlterAuthorizationStatementSegment").to_matchable(),
            Ref::new("GrantStatementSegment").to_matchable(),
            Ref::new("DenyStatementSegment").to_matchable(),
            ...
            Ref::new("CreateExternalTableAsSelectStatementSegment").to_matchable(),
    ...
    // CREATE EXTERNAL TABLE AS SELECT (CETAS) (#7595)
    // https://learn.microsoft.com/en-us/sql/t-sql/statements/create-external-table-as-select-transact-sql
    dialect.add([(
        "CreateExternalTableAsSelectStatementSegment".into(),
        NodeMatcher::new(SyntaxKind::CreateExternalTableAsSelectStatement, |_| {
            Sequence::new(vec![
                Ref::keyword("CREATE").to_matchable(),
                Ref::keyword("EXTERNAL").to_matchable(),
                Ref::keyword("TABLE").to_matchable(),
    ...
    // https://learn.microsoft.com/en-us/sql/t-sql/statements/deny-transact-sql
    // https://learn.microsoft.com/en-us/sql/t-sql/statements/revoke-transact-sql
    dialect.add([
        (
            "SecurableSegment".into(),
            NodeMatcher::new(SyntaxKind::SecurableSegment, |_| {
                Sequence::new(vec![
                    Sequence::new(vec![
                        one_of(vec![
                            Ref::keyword("ASSEMBLY").to_matchable(),
                            Sequence::new(vec![
        ...
        (
            "PermissionsSegment".into(),
            NodeMatcher::new(SyntaxKind::PermissionsSegment, |_| {
                let alter_any = Sequence::new(vec![
                    Ref::keyword("ALTER").to_matchable(),
                    ...
                    one_of(vec![
                        ...
                        .to_matchable(),
                        Sequence::new(vec![
                            Ref::keyword("AVAILABILITY").to_matchable(),
                            Ref::keyword("GROUP").to_matchable(),
                        ])
                        .to_matchable(),
                        Ref::keyword("CONNECTION").to_matchable(),
                        ...
                        .to_matchable(),
                        Ref::keyword("CONTRACT").to_matchable(),
                        Ref::keyword("DATABASE").to_matchable(),
                        Sequence::new(vec![
                            Ref::keyword("DATABASE").to_matchable(),
                        ...
                        .to_matchable(),
                        Ref::keyword("DATASPACE").to_matchable(),
                        Ref::keyword("ENDPOINT").to_matchable(),
                        Sequence::new(vec![
                            Ref::keyword("EVENT").to_matchable(),
                            Ref::keyword("NOTIFICATION").to_matchable(),
                        ])
                        ...
                        .to_matchable(),
                        Sequence::new(vec![
                            Ref::keyword("LINKED").to_matchable(),
                            Ref::keyword("SERVER").to_matchable(),
                        ])
                        .to_matchable(),
                        Ref::keyword("LOGIN").to_matchable(),
                        ...
                        .to_matchable(),
                        Sequence::new(vec![
                            Ref::keyword("SENSITIVITY").to_matchable(),
                            Ref::keyword("CLASSIFICATION").to_matchable(),
                        ])
                        .to_matchable(),
                        Sequence::new(vec![
                            Ref::keyword("SERVER").to_matchable(),
                ...
                let create_permission = Sequence::new(vec![
                    Ref::keyword("CREATE").to_matchable(),
                    one_of(vec![
                ...
                let permission = one_of(vec![
                    Sequence::new(vec![
                        Ref::keyword("ADMINISTER").to_matchable(),
                        Ref::keyword("BULK").to_matchable(),
                        Ref::keyword("OPERATIONS").to_matchable(),
                    ])
                    .to_matchable(),
                    Sequence::new(vec![
                        Ref::keyword("ADMINISTER").to_matchable(),
                    ...
                    Sequence::new(vec![
                        Ref::keyword("ALTER").to_matchable(),
                        Ref::keyword("RESOURCES").to_matchable(),
                    ])
                    .to_matchable(),
                    Sequence::new(vec![
                        Ref::keyword("ALTER").to_matchable(),
                    ...
                    .to_matchable(),
                    Ref::keyword("AUTHENTICATE").to_matchable(),
                    Sequence::new(vec![
                        Ref::keyword("AUTHENTICATE").to_matchable(),
                        Ref::keyword("SERVER").to_matchable(),
                    ])
                    ...
                    .to_matchable(),
                    Ref::keyword("CONTROL").to_matchable(),
                    Sequence::new(vec![
                        Ref::keyword("CONTROL").to_matchable(),
                        Ref::keyword("SERVER").to_matchable(),
                    ])
                    ...
                    .to_matchable(),
                    Ref::keyword("RECEIVE").to_matchable(),
                    Ref::keyword("REFERENCES").to_matchable(),
                    Ref::keyword("SELECT").to_matchable(),
                    Sequence::new(vec![
                        Ref::keyword("SELECT").to_matchable(),
                        Ref::keyword("ALL").to_matchable(),
                        Ref::keyword("USER").to_matchable(),
                        Ref::keyword("SECURABLES").to_matchable(),
                    ])
                    .to_matchable(),
                    Ref::keyword("SHOWPLAN").to_matchable(),
                    Ref::keyword("SHUTDOWN").to_matchable(),
                    Ref::keyword("SEND").to_matchable(),
                    Sequence::new(vec![
                        Ref::keyword("SUBSCRIBE").to_matchable(),
                        Ref::keyword("QUERY").to_matchable(),
                        Ref::keyword("NOTIFICATIONS").to_matchable(),
                    ])
                    .to_matchable(),
                    Sequence::new(vec![
                        Ref::keyword("TAKE").to_matchable(),
                        Ref::keyword("OWNERSHIP").to_matchable(),
                    ])
                    .to_matchable(),
                    Ref::keyword("UNMASK").to_matchable(),
                    Sequence::new(vec![
                    ...
                    Sequence::new(vec![
                        ...
                        Ref::keyword("TRACKING").to_matchable(),
                    ])
                    .to_matchable(),
                    Sequence::new(vec![
                        Ref::keyword("VIEW").to_matchable(),
        ...
        (
            "AlterAuthorizationStatementSegment".into(),
            NodeMatcher::new(SyntaxKind::AlterAuthorizationStatement, |_| {
                Sequence::new(vec![
                    Ref::keyword("ALTER").to_matchable(),
                    Ref::keyword("AUTHORIZATION").to_matchable(),
                    Ref::keyword("ON").to_matchable(),
        ...
        (
            ...
            NodeMatcher::new(SyntaxKind::GrantStatement, |_| {
                Sequence::new(vec![
                    ...
                    one_of(vec![
                        Ref::new("PermissionsSegment").to_matchable(),
                        Sequence::new(vec![
                            Ref::keyword("ALL").to_matchable(),
        ...
        (
            "DenyStatementSegment".into(),
            NodeMatcher::new(SyntaxKind::DenyStatement, |_| {
                Sequence::new(vec![
                    Ref::keyword("DENY").to_matchable(),
                    one_of(vec![
                        Ref::new("PermissionsSegment").to_matchable(),
                        Sequence::new(vec![
                            Ref::keyword("ALL").to_matchable(),
            ...
            NodeMatcher::new(SyntaxKind::AlterUserStatement, |_| {
                let set_item = one_of(vec![
                    ...
                    Sequence::new(vec![
                        ...
                        Ref::new("QuotedLiteralSegment").to_matchable(),
                        Sequence::new(vec![
                            Ref::keyword("OLD_PASSWORD").to_matchable(),
                            Ref::new("EqualsSegment").to_matchable(),
                            Ref::new("QuotedLiteralSegment").to_matchable(),
                        ])
                        .config(|this| this.optional())
                ...
                Sequence::new(vec![
                    ...
                    Ref::new("RoleReferenceSegment").to_matchable(),
                    Ref::keyword("WITH").to_matchable(),
                    Delimited::new(vec![set_item]).to_matchable(),
                ])
                .to_matchable()
            })
            .to_matchable()
...
fn add_database_grammars(dialect: &mut Dialect) {
    ...
    dialect.add([(
        "RestoreDatabaseStatementSegment".into(),
        NodeMatcher::new(SyntaxKind::RestoreDatabaseStatement, |_| {
            let backup_device = one_of(vec![
                Sequence::new(vec![
                    one_of(vec![
                        Ref::keyword("DISK").to_matchable(),
                        Ref::keyword("TAPE").to_matchable(),
            ...
            let files_or_filegroups = one_of(vec![
                Sequence::new(vec![
                    Ref::keyword("FILE").to_matchable(),
                    Ref::new("EqualsSegment").to_matchable(),
                    one_of(vec![
                ...
                .to_matchable(),
                Ref::keyword("READ_WRITE_FILEGROUPS").to_matchable(),
            ])
            .to_matchable();

            let quoted_or_parameter = || {
                one_of(vec![
                    Ref::new("QuotedLiteralSegment").to_matchable(),
                    Ref::new("ParameterNameSegment").to_matchable(),
                ])
            ...
            let general_with_options = one_of(vec![
                Ref::keyword("RECOVERY").to_matchable(),
                Ref::keyword("NORECOVERY").to_matchable(),
                Sequence::new(vec![
                    Ref::keyword("STANDBY").to_matchable(),
                    Ref::new("EqualsSegment").to_matchable(),
                    quoted_or_parameter(),
                ])
                .to_matchable(),
                Sequence::new(vec![
                    Ref::keyword("MOVE").to_matchable(),
                    Ref::new("QuotedLiteralSegment").to_matchable(),
                    Ref::keyword("TO").to_matchable(),
                    Ref::new("QuotedLiteralSegment").to_matchable(),
                ])
                ...
                .to_matchable(),
                Sequence::new(vec![
                    Ref::keyword("MEDIANAME").to_matchable(),
                    Ref::new("EqualsSegment").to_matchable(),
                    quoted_or_parameter(),
                ])
                .to_matchable(),
                Sequence::new(vec![
                    Ref::keyword("MEDIAPASSWORD").to_matchable(),
                    Ref::new("EqualsSegment").to_matchable(),
                    quoted_or_parameter(),
                ])
                .to_matchable(),
                Sequence::new(vec![
                    Ref::keyword("BLOCKSIZE").to_matchable(),
                    Ref::new("EqualsSegment").to_matchable(),
                    numeric_or_parameter(),
                ])
                .to_matchable(),
                Sequence::new(vec![
                    Ref::keyword("BUFFERCOUNT").to_matchable(),
                    Ref::new("EqualsSegment").to_matchable(),
                    numeric_or_parameter(),
                ])
                .to_matchable(),
                Sequence::new(vec![
                    Ref::keyword("MAXTRANSFERSIZE").to_matchable(),
                    Ref::new("EqualsSegment").to_matchable(),
                    numeric_or_parameter(),
                ])
                .to_matchable(),
                Ref::keyword("CHECKSUM").to_matchable(),
                Ref::keyword("NO_CHECKSUM").to_matchable(),
                Ref::keyword("STOP_ON_ERROR").to_matchable(),
                Ref::keyword("CONTINUE_AFTER_ERROR").to_matchable(),
                Sequence::new(vec![
                ...
                .to_matchable(),
                Ref::keyword("REWIND").to_matchable(),
                Ref::keyword("NOREWIND").to_matchable(),
                Ref::keyword("UNLOAD").to_matchable(),
                Ref::keyword("NOUNLOAD").to_matchable(),
                Ref::keyword("NO_TRUNCATE").to_matchable(),
                Ref::keyword("ENABLE_BROKER").to_matchable(),
                Ref::keyword("ERROR_BROKER_CONVERSATIONS").to_matchable(),
                Ref::keyword("NEW_BROKER").to_matchable(),
            ])
            ...
            Sequence::new(vec![
                ...
                .to_matchable(),
                Delimited::new(vec![files_or_filegroups])
                    .config(|this| this.optional())
                    .to_matchable(),
                Sequence::new(vec![
                    Ref::keyword("FROM").to_matchable(),
                    Delimited::new(vec![backup_device]).to_matchable(),
                ])
                .config(|this| this.optional())
                .to_matchable(),
                Sequence::new(vec![
                    Ref::keyword("WITH").to_matchable(),
                    Delimited::new(vec![general_with_options]).to_matchable(),
                ])
                .config(|this| this.optional())
                .to_matchable(),
            ])
