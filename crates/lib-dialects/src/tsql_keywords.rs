...
pub(crate) fn tsql_additional_reserved_keywords() -> FxHashSet<&'static str> {
    [
...
pub(crate) fn tsql_future_keywords() -> FxHashSet<&'static str> {
    [
...
pub(crate) fn tsql_additional_unreserved_keywords() -> FxHashSet<&'static str> {
...
#[allow(dead_code)]
pub(crate) fn tsql_reserved_keywords() -> FxHashSet<&'static str> {
...
#[allow(dead_code)]
pub(crate) fn tsql_unreserved_keywords() -> FxHashSet<&'static str> {
